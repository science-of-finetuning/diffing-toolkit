...
Relevant code for the Activation Difference Lens is found at [src/diffing/methods/activation_difference_lens](src/diffing/methods/activation_difference_lens) and used utilities at [src/utils](src/utils). Plotting scripts are found under [narrow_ft_experiments/plotting/](narrow_ft_experiments/plotting/). The statistical evaluation of the agent performance using HiBayes can be found in [narrow_ft_experiments/hibayes/](hibayes).
