...
N_RANDOM_RUNS = 5  # Number of random initializations per token position count
BASE_SEED = 42
...
OUTPUT_DIR = Path("/workspace/diffing-toolkit/logit_diff_experiments/token_positions_experiments")
