...
def plot_ordering_scatter(
    ...
    if top_k_labels > 0:
        ...
        font_props = matplotlib.font_manager.FontProperties(family=UNICODE_FONTS, size=8)
...
def plot_ordering_bar_chart(
    ...
    ax.set_yticks(y_pos)
    ax.set_yticklabels(labels, fontsize=9, fontproperties=matplotlib.font_manager.FontProperties(family=UNICODE_FONTS))
